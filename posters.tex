...
\begin{revnumerate}[6]
\item{\textsc{What Can Supernovae Tell us About Massive Stars}\\
{\bf Bostroem, K. A.}; Valenti, S.; Sand, D.; Morozova, V.; Jerkstrand, A.; Horesh, A.; et al, STScI Spring Symposium, 2019}\\

\item{\textsc{Do Type IIP/IIL Supernovae Experience Interaction?}\\ 
...
\item{\textsc{Spectral Types and Wind Velocities for Massive Stars in R136}\\
...
\item{\textsc{New HST/STIS Spectroscopy of Massive Members of R136 in 30 Doradus}\\ 
...
\item{\textsc{Long-Slit Spectroscopy for 30 Doradus}\\ 
{\bf Bostroem, K. A.}; Walborn, N.; Crowther, P.; ; Lennon, D.; Ma\'{i}z Apell\'{a}niz, J.,  American Astronomical Society, AAS Meeting \#221, 2013}\\

\item{\textsc{An Update on the Performance of the Space Telescope Imaging Spectrograph}\\
